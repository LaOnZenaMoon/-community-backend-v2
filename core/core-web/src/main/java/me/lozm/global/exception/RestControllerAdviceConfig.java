...
import static me.lozm.global.model.CommonResponseDto.internalServerError;
...
public class RestControllerAdviceConfig {
    ...
    protected ResponseEntity<CommonResponseDto<Object>> handleInternalServerException(InternalServerException e) {
        log.error(">> InternalServerException, message: {}", e.getMessage());
        e.printStackTrace();
        return internalServerError(e.getType());
    }
